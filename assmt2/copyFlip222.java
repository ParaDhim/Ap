...
class FunctionsOfProductID {
    public boolean checkProductIDExistance(double proID,Admin adminIIIT) {
        boolean flag = false;
        for (ArrayList<Double> element : adminIIIT.getCategoryProductsID()) {
    ...
    public String getProductNameFromProductID(double productID,Admin adminIIIT) {
        int i = 0;
        for (ArrayList<Double> element : adminIIIT.getCategoryProductsID()) {
            int j = 0;
            for (double element1:element) {
                if (element1 == productID) {
                    return adminIIIT.getCategoryProductsName().get(i).get(j);
                }
                j++;
...
class Admin extends FunctionsOfProductID{
    ...
    public ArrayList<ArrayList<String>> getCategoryProductsName() {
        return categoryProductsName;
    }
    public void addAdminUsername(String adminUsername) {
        this.usrname.add(adminUsername);
    }

    public void addAdminPasswd(String adminPasswd) {
        this.adminPassword.add(adminPasswd);
    }

    public void addAdminRollNo(int adminRollNo) {
        this.rollNo.add(adminRollNo);
    }

    public ArrayList<Integer> getRollNo() {
        return rollNo;
    }
    ...
    public void addUserAdmin(String adminUsername, String adminPasswd, int adminRollNo) {
        this.addAdminPasswd(adminPasswd);
        this.addAdminUsername(adminUsername);
        this.addAdminRollNo(adminRollNo);
    }
...
//            System.out.println(element);
            if (Objects.equals(usrname, element)) {
...
//            System.out.println(element);
    ...
    public int getCatIndex(String catName) {
        ...
        for (String element : this.category) {
            ...
            if (Objects.equals(element, catName)) {
                break;
            }
            i += 1;
        }
    ...
    public int getProductIndex(String productName, String catName) {
        ...
        for (String element : this.categoryProductsName.get(getCatIndex(catName))) {
            ...
            if (Objects.equals(element, productName)) {
                break;
            }
            i += 1;
        }
...
//    getca
    ...
    public String getUsrname(int idx) {
        return this.usrname.get(idx);
    }

    public Integer getRollNo(int idx) {
        return this.rollNo.get(idx);
    }
...
class Customer implements ProductCatalog{
    ...
    private ArrayList<String> adminUsername = new ArrayList<String>();
    private ArrayList<Integer> adminRollNo = new ArrayList<Integer>();
    private ArrayList<String> adminPasswd = new ArrayList<String>();
...
//    //Sequence name,age,phNo,EmailID,passwd
    ...
    public boolean logIn(String regName,String emailID,String regPassword) {
        ...
        for (String element : this.normalCusName) {
            if (Objects.equals(element, regName)) {
                if (Objects.equals(this.normalCusPasswd.get(i), regPassword)) {
                    if (Objects.equals(this.normalCusEmailID.get(i), emailID)) {
                        flag = true;
                        return flag;
                    }
                }
        ...
        for (String element : this.eliteCusName) {
            if (Objects.equals(element, regName)) {
                if (Objects.equals(this.eliteCusPasswd.get(i), regPassword)) {
                    if (Objects.equals(this.eliteCusEmailID.get(i), emailID)) {
                        flag = true;
                        return flag;
                    }
                }
        ...
        for (String element : this.primeCusName) {
            if (Objects.equals(element, regName)) {
                if (Objects.equals(this.primeCusPasswd.get(i), regPassword)) {
                    if (Objects.equals(this.primeCusEmailID.get(i), emailID)) {
                        flag = true;
                        return flag;
                    }
                }
...
//    private ArrayList<Integer> productID = new ArrayList<Integer>();
    ...
    public void upgradeStatus(String regName, String emailID, String regPassword,String newStatus,String oldStatus) {
        if (Objects.equals(newStatus, "ELITE") && Objects.equals(oldStatus, "NORMAL")) {
        ...
        } else if (Objects.equals(newStatus, "ELITE") && Objects.equals(oldStatus, "PRIME")) {
        ...
        } else if (Objects.equals(newStatus, "PRIME") && Objects.equals(oldStatus, "NORMAL")) {
            int normIdx = getindexRegUserLogIn(regName, emailID, regPassword);
    ...
    public void addToWallet(String cusUsrname, String cusEmail, String cusPasswd, String stat,int amount) {
        if (Objects.equals(stat, "ELITE")) {
            int i = 0;
            for (String element : this.eliteCusName) {
                if (Objects.equals(element, cusUsrname)) {
        ...
        } else if (Objects.equals(stat, "PRIME")) {
            int i = 0;
            for (String element : this.primeCusName) {
                if (Objects.equals(element, cusUsrname)) {
...
//        System.out.println(this.cusCartProductID);
    ...
    public void checkOut(Admin adminIIITD,String stat,String cusUsrname, String cusEmail, String cusPasswd) {
        for (double element : this.cusCartProductID) {
            ...
            String proName = adminIIITD.getProductNameFromProductID(element,adminIIITD);
        ...
        for (ArrayList<Double> element : this.cusCartProductDeals) {
            String proName1 = adminIIITD.getProductNameFromProductID(element.get(0),adminIIITD);
            String proName2 = adminIIITD.getProductNameFromProductID(element.get(1),adminIIITD);
                ...
                while (lop3 == 1) {
                    ...
                    if (operate3 == 1) {
                        System.out.println("To SignUp\n" +
                                "Please enter your username, password and rollno\n");
                        sc.nextLine();
                        System.out.println("Enter Your name:");
                        String adminName = sc.nextLine();
                        System.out.println("Enter Your Rollno:");
                        int adminRollNo = sc.nextInt();
                        System.out.println("Enter Your Password:");
                        sc.nextLine();
                        String adminPasswd = sc.nextLine();
                        adminIIIT.addUserAdmin(adminName, adminPasswd, adminRollNo);
                    } else if (operate3 == 2) {
                        System.out.println("Dear Admin,\n" +
                                "Please enter your username and rollNo\n");
                        sc.nextLine();
                        String usrname = sc.nextLine();
//                        adminIIIT.getUsrname(0);
                        System.out.println(adminIIIT.getUsrname());
                        int rollNo = sc.nextInt();
//                        adminIIIT.getRollNo(0);
                        System.out.println(adminIIIT.getRollNo());
//                        System.out.println(adminIIIT.checkAdmin(usrname, rollNo));
                        if (adminIIIT.checkAdmin(usrname, rollNo)) {
                            int lop1 = 1;
                            while (lop1 == 1) {
                                ...
                                if (operate1 == 1) {
                                    ...
                                    if ((adminIIIT.checkProductIDExistance(proID1, adminIIIT)) && (adminIIIT.checkProductIDExistance(proID2, adminIIIT))) {
...
//                    } else {
//                        operate3 = 0;
//                        System.out.println("Exiting1 ---- chosen to exit or entered wrong Input");
//                    }}
                ...
                while (operate2lop == true) {
                    ...
                    int a = sc.nextInt();
                    if (a == 1) {
                        if (!adminIIIT.getCategoryProductsID().isEmpty()) {
                ...
                if (!adminIIIT.getGiveAwayDealPricing().isEmpty()) {
                    int i = 0;
...
//                        System.out.println(cusPhNo);
                        ...
                        if (customerIIIT.logIn(cusUsrname, cusEmail, cusPasswd)) {
